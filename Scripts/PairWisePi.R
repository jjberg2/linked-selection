...
setwd("~/Documents/Academics/CoopLab/Projects/StandingSweeps/Sims")
...
source('~/Documents/Academics/CoopLab/Projects/StandingSweeps/Scripts/SweepFromStandingSim.R', chdir = TRUE)
source ( "~/Documents/Academics/CoopLab/Projects/StandingSweeps/Scripts/run.ms.functions.R")
real.fs <- c ( 0.001 , 0.01 , seq ( 0.02 , 0.1 , length = 5 ) )
...
save ( many.sim.freqs  ,  file = "~/Documents/Academics/CoopLab/Projects/StandingSweeps/Sims/freqs.traj.s05.Rdata"  )
for ( i in 1 : length ( real.fs ) ) {
	run.ms.f ( runs = my.runs [[ i ]] [[ 1 ]] , n.sam = 2 , f = real.fs [ i ] , s = 0.05 , N = 10000 , path = "~/Documents/Academics/CoopLab/Projects/StandingSweeps/" )
}
