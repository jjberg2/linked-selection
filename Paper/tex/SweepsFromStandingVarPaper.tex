...
One of the most easily noticeable factors which distinguishes the OHFS of a standing sweep from that of a hard sweep is that for a window of a given size, $h_1$ will be lower for a standing sweep than for a hard sweep, and there will tend to be more distinct haplotypes for a standing sweep than for a hard sweep. This is purely due to the fact that the there is more time in the genealogy at the selected site for a standing sweep than for a hard sweep of equal strength, giving more opportunity for both recombination events and new mutations to create new haplotypes. Given that a new haplotypes has been created, it is most likely to have been created by budding off from the most frequent haplotype. 

The other major distinguishing factor between a standing sweep and a hard sweep is that the genealogy for a hard sweep has most of its branch length near the tips, whereas a standing sweep has a genealogy that more closely resembles the neutral coalescent. As a consequence, there is a large range of $L$ for which values of $h_2 - h_{0.2\times n}$ will tend to be larger for a hard sweep than a soft sweep. Very close to the selected site 
