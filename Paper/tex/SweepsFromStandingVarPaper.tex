...
\begin{equation}
	\mathbb{E}\left(\frac{\pi_R}{\pi_0}\right) \approx \left(1-\frac{1}{1 + R_f} e^{-r\frac{ln\left(\frac{1}{f}\right)}{s}}  \right). \label{pi_reduc}
\end{equation}
...
It is worth noting however that all of our results are obtained for populations with equilibrium demographics, 
