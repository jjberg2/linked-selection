...
\jb{currently working in this paragraph}
We will again rely on the condition that $f \ll 1$, and assume that any lineage that recombines out of the background of our beneficial allele will not recombine back into that background before it is removed by mutation. We are interested in the joint history of coalescence and recombination events at the \fancyN locus given the this approximation to the recombination process and our approximation to the coalescent process Under these assumptions, as we move away from the \fancyB locus, recombinations appear as events on the genealogy that peel lineages out from the beneficial class allowing them to coalescence on a much longer time scale in the non-beneficial background. In Figure \ref{cartoon_fig_1}B we show the coalescent genealogy at the selected site, and show recombination events out of the benefical allele class imposed on the genealogy (these events are colored to correspond to the events on the haplotypes in Figure \ref{cartoon_fig_1}A). In 
