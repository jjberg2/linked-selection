...
\subsubsection{Neutral phase}
Looking backward in time, having sampled $k$ lineages at the \fancyN locus at $t=0$, we arrive at the beginning of the neutral phase at time $\tau$ with $k-i$ lineages linked to the non-beneficial background at the \fancyB locus (which has a frequency of $1-f$), and $i$ lineages linked to the beneficial background (which has a frequency of $f$).
